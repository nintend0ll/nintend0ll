...
A project focused on improving **medication management in residential care facilities**.

The goal is to help caregivers keep track of medications, patients and administration while providing a simple and reliable system.
...
Built with a focus on responsive design, clean UI and a little bit of personality.
...
A desktop application developed while practicing **Object-Oriented Programming and MVC architecture**.

Built with Java Swing, focusing on application structure and separation of responsibilities.
...
Small frontend experiments where I explore layouts, animations, UI ideas and different web technologies.

Some projects start with a simple:

> *"I wonder if I can make this..."*

and then become something completely different. ✨
